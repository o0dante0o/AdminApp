...
const items = [
    ...
    {head: 'Data', title:'Manage Team',to:'/team',icon:<PeopleOutlinedIcon />},
    ...
    {head: 'Pages', title:'Profile Form',to:'/form',icon:<PersonOutlinedIcon />},
    {title:'Calendar',to:'/calendar',icon:<CalendarTodayOutlinedIcon />},
    {title:'FAQ Page',to:'/faq',icon:<HelpOutlinedIcon />},
    {head: 'Charts', title:'Bar Chart',to:'/bar',icon:<BarChartOutlinedIcon/>},
                ...
                <Menu iconShape='square'>
                    ...
                    <Box mb='25px'>
                        ...
                        <Box textAlign = 'center'>
                            <Typography variant = 'h2' color={colors.grey[100]} fontWeight='bold' sx={{ m: '10px 0 0 0'}}> A-Vision</Typography>
                            <Typography variant = 'h5' color = {colors.greenAccent[500]}>Software Development</Typography>
                        </Box>
                    </Box>
                    )}
